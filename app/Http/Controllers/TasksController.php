...
class TasksController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            $posts = Task::latest()->paginate($perPage);
        } else {
            $posts = Task::latest()->paginate($perPage);
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/posts')->with('flash_message', 'Task added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/posts')->with('flash_message', 'Task updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/posts')->with('flash_message', 'Task deleted!');
    }
}
